  ...
  <div>
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active btn btn-primary text-white" id="tenancy-tab" data-bs-toggle="tab"
          data-bs-target="#tenancy" type="button" role="tab" aria-controls="tenancy" aria-selected="true">
    ...
    <div class="row justify-content-center">
      <div class="col-xxl-10">
        <div class="card shadow-lg" id="demo">
          ...
          <div class="card-header d-flex flex-wrap align-items-center mb-3 gap-2">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="tenantName" v-model="tenancy.tenant.tenant_name"
                    disabled />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="propertyAddress" class="form-label">Property</label>
                  <input type="text" class="form-control" id="propertyAddress" v-model="tenancy.property.property_name"
                    disabled />
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="propertyAddress" class="form-label">Lease Start Date</label>
                  <input type="text" class="form-control" id="propertyAddress" v-model="tenancy.lease_start_date"
                    disabled />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="propertyAddress" class="form-label">Lease End Date</label>
                  <input type="text" class="form-control" id="propertyAddress" v-model="tenancy.lease_end_date"
                    disabled />
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="propertyAddress" class="form-label">Lease End Date</label>
                  <input type="text" class="form-control" id="propertyAddress" v-model="tenancy.lease_duration"
                    disabled />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="propertyAddress" class="form-label">Next Payment</label>
                  <input type="text" class="form-control" id="propertyAddress" v-model="tenancy.due_date" disabled />
                </div>
              </div>
            </div>

            <!-- Update Status Modal -->
            <div class="modal fade" tabindex="-1" role="dialog" id="modalTenant" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Update Tenancy Status</h5>
                  ...
                  <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <select id="statusDropdown" class="form-control" v-model="selectedStatus">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="submitStatusUpdate">Update</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="table-responsive">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8">
                  <input v-model="searchQuery" type="text" class="form-control" placeholder="Search by any field..." />
                </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr v-for="(payment, index) in paginatedPayments" :key="payment.id">
                    ...
                    <td>
                      <a v-bind:href="'/real_estate_ms/public/tenant/' +
                        tenancy.tenant.tenant_no +
                        '/' +
                        payment.proof_of_payment
                        " target="_blank">{{ payment.proof_of_payment }}</a>
                    </td>
                ...
                <tfoot>
                  <tr>
                    <td colspan="7" class="text-end" style="font-weight: bold; background-color: #f8f9fa">
                      Total Amount:
                    </td>
